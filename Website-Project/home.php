...
<body>
  ...
  <div class="container">
    <div class="brand">
      <img id="logo" src="/Soen_Project/home_Page/Images/logo.png" alt="logo_image.png">
    </div>
    ...
    <nav class="navbar">
      <ul class="menu">
        <li class="menu-items">
          <a href="/Soen_Project/home_page/home.php">Home</a>
        </li>
        <li class="menu-items">
          <a href="/Soen_Project/About/about.php">About</a>
        </li>
        ...
        <li class="menu-items">
          <a href="/Soen_Project/Jason-Volunteer/volunteer.html">Volunteer</a>
        </li>
        <li class="menu-items">
          <a href="/Soen_Project/Donate/donate.html">Donate</a>
        </li>
        <li class="menu-items">
          <a href="/Soen_Project/Contact-Us_page/contact-us.html">Contact us</a>
        </li>
      </ul>
    </nav>
  </div>
  ...
  <div id="page">
    ...
    <img src="Images/home_pic.jpg" alt="" id="home_pic">
      ...
      <div class="btn-three">
        <button type="button" name="button" class="btn-home"><a href="/Soen_Project/Donate/donate.html" class="">Donate</a></button>
        <button type="button" name="button" class="btn-home"><a href="/Soen_Project/About/about.php">About</a></button>
